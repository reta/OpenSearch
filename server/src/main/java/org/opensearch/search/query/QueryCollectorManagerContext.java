...
abstract class QueryCollectorManagerContext {
    private static class QueryCollectorManager implements CollectorManager<MultiCollectorManager.Collectors, ReduceableSearchResult> {
        ...
        @Override
        public ReduceableSearchResult reduce(Collection<MultiCollectorManager.Collectors> collectors) throws IOException {
    ...
    static CollectorManager<? extends Collector, ReduceableSearchResult> createOpaqueCollectorManager(
    ...
    static CollectorManager<? extends Collector, ReduceableSearchResult> createMultiCollectorManager(List<QueryCollectorContext> collectors)
        throws IOException {
    ...
    static ProfileCollectorManager<? extends Collector, ReduceableSearchResult> createQueryCollectorManagerWithProfiler(
