 ...
 * @author kimchy
 */
public class S3DirectoryBenchmarkIT extends AbstractS3DirectoryIT {
    private static final Logger logger = LoggerFactory.getLogger(S3DirectoryBenchmarkIT.class);
    ...
    public void testTiming() throws IOException {
        ...
        logger.info("RAMDirectory Time: " + ramTiming + " ms");
        logger.info("FSDirectory Time : " + fsTiming + " ms");
        logger.info("S3Directory Time : " + s3Timing + " ms");
    }
