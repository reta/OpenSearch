...
import com.erudika.lucene.store.s3.AbstractS3DirectoryIT;
...
import static com.erudika.lucene.store.s3.S3DirectoryGeneralOperationsIT.TEST_BUCKET;

/**
 * @author kimchy
 */
public abstract class AbstractIndexInputOutputIT extends AbstractS3DirectoryIT {
    ...
    private void innerTestSize(final int bufferSize) throws IOException {
        s3Directory.getSettings().getDefaultFileEntrySettings().setIntSetting(S3BufferedIndexInput.BUFFER_SIZE_SETTING, bufferSize);
        s3Directory.getSettings().getDefaultFileEntrySettings().setIntSetting(S3BufferedIndexOutput.BUFFER_SIZE_SETTING, bufferSize);
    ...
    private void insertData() throws IOException {
        ...
        try (IndexOutput indexOutput = s3Directory.createOutput("value1", IOContext.DEFAULT)) {
    ...
    private void verifyData() throws IOException {
        ...
        try (IndexInput indexInput = s3Directory.openInput("value1", IOContext.DEFAULT)) {
