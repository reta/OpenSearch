 ...
 * @author kimchy
 */
public class S3DirectoryGeneralOperationsIT extends AbstractS3DirectoryIT {

    private static S3Directory s3Directory;

    public static final String TEST_BUCKET = "s3-lucene-dir";
    public static final String TEST_BUCKET1 = "s3-lucene-dir1";
    public static final String TEST_BUCKET2 = "s3-lucene-dir3";
    ...
    public void testList() throws IOException {
        ...
        try (IndexOutput indexOutput = s3Directory.createOutput("test1", IOContext.DEFAULT)) {
