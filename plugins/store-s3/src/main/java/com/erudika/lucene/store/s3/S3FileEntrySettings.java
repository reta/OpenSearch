 ...
 * <p>
 * Default values for a new instanciated instance are:
 * {@link com.erudika.lucene.store.s3.handler.ActualDeleteFileEntryHandler} for the {@link #FILE_ENTRY_HANDLER_TYPE}
 * setting, {@link com.erudika.lucene.store.s3.index.FetchOnBufferReadS3IndexInput} for the
 * {@link #INDEX_INPUT_TYPE_SETTING} setting, and {@link com.erudika.lucene.store.s3.index.RAMS3IndexOutput} for
...
public class S3FileEntrySettings {
     ...
     * {@link com.erudika.lucene.store.s3.handler.FileEntryHandler}s that use it.
     */
    ...
    /**
     * The class name of the {@link com.erudika.lucene.store.s3.handler.FileEntryHandler}.
     */
